...
public class EditorButtonPropertyDrawer : PropertyDrawer
{
    ...
    {
        EditorButtonAttribute inspectorButtonAttribute = (EditorButtonAttribute)attribute;
        ...
        if (GUI.Button(buttonRect, label.text))
        {
            ...
            if (_eventMethodInfo != null)
                ...
                Debug.LogWarning(string.Format("EditorButton: Unable to find method {0} in {1}", eventName, eventOwnerType));
        }
    }
}
#endif